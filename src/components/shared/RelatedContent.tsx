            ...
            <div className="space-y-2">
              {relatedLinks.map((r) => (
                <button
                  ...
                  className="w-full text-left px-3 py-2.5 bg-background border border-border rounded-xl text-sm text-muted-foreground hover:text-foreground hover:border-primary/30 transition-all"
                >
                  {r.label}
                </button>
              ))}
              ...
              {others.map((c) => {
                ...
                return (
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-3 py-2.5 bg-background border border-border rounded-xl text-sm text-muted-foreground hover:text-foreground hover:border-primary/30 transition-all"
                  >
